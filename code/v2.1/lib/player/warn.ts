...
const notifyTypes = new class notifyTypes {
  ...
  "action_bar"(player: Player, message: Message): void { player.onScreenDisplay.setActionBar(message) }

  "title"(player: Player, message: Message): void { player.onScreenDisplay.setTitle(message) }
}
